...
/* File Aur_num.h
 * Allows same basic code for all aural funtions.
 * Need a modified copy in each aural directory. 
 */

#define DSPSOFT_32_BIT

/* Define function call names */
#define DSPS_AURAL_RUN dspsAuralRun
#define DSPS_AURAL_INIT dspsAuralInit
#define DSPS_AURAL_PROCESS dspsAuralProcess32
