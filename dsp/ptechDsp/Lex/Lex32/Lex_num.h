...
/* File Pr1_num.h
 * Allows same basic code for all proto1 funtions.
 * Need a modified copy in each proto1 directory. 
 */

#define DSPSOFT_32_BIT

#define DSPS_LEX_RUN dspsLexReverbRun
#define DSPS_LEX_INIT dspsLexReverbInit
#define DSPS_LEX_PROCESS dspsLexReverbProcess32
