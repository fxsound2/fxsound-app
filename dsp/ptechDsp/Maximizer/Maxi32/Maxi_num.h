...
/* File Maxi_num.h
 * Allows same basic code for all Maximizer funtions.
 * Need a modified copy in each Maximizer directory. 
 */

#define DSPSOFT_32_BIT

#define DSPS_MAXI_RUN dspsMaximizerRun
#define DSPS_MAXI_INIT dspsMaximizerInit
#define DSPS_MAXI_PROCESS dspsMaximizerProcess32
