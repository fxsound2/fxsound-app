...
/*
 * FILE: Play32DMX.c
 * NOTE - Special version for DMX that has mono gain consistent with stereo gain
 * DATE: 4/24/99
		...
		if( s->bassboost_on )
		{
			...
			for(i=0; i<l_length; i++)
			{
				...
				if(s->stereo_in_flag)
				{
					...
					/* DMX mod - normally out2 assigned to out1, giving extra gain in mono case.
					 * DMX wants consistency in mono and stereo gains so out2 is assigned to 0.0.
					 */
					out2 = (float)0.0;
