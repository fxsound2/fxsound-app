 ...
 */
 ...
 /* File Play_num.h
 * Allows same basic code for all Play functions.
 * Need a modified copy in each Play directory. 
 */

/* Define function call names */
#define DSPS_PLAY_RUN dspsPlayRun
#define DSPS_PLAY_INIT dspsPlayInit
#define DSPS_PLAY_PROCESS dspsPlayProcess
