...
/* pwav.cpp */
int PT_DECLSPEC pwavNew(PT_HANDLE **, CSlout *, int32_t, DWORD, int); 
int PT_DECLSPEC pwavResetBufferSize(PT_HANDLE *, int32_t, int);
int PT_DECLSPEC pwavReadHeader(PT_HANDLE *, wchar_t *, wchar_t *, int, int, int *, int32_t *, int32_t *, int *);
int PT_DECLSPEC pwavReadNextBuffer(PT_HANDLE *, int, int32_t **, int32_t *, int32_t *, int, int);  
int PT_DECLSPEC pwavGetBuffer(PT_HANDLE *, int, int32_t **);
int PT_DECLSPEC pwavGetTempFloatBuffer(PT_HANDLE *, realtype **);
int PT_DECLSPEC pwavPlayBuffer(PT_HANDLE *, int, int32_t); 
...
/* pwavUtil */
int PT_DECLSPEC pwavCheckIfLegalSampFreq(int32_t, int *);
