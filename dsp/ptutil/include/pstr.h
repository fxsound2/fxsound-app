 ...
 * DESCRIPTION:
 *
 *  Public defines for the pstr module (string functions)
 */
...
/* pstrMail.cpp */
int PT_DECLSPEC pstrIsEmailAddressValid_Wide(wchar_t *, int *);
int PT_DECLSPEC pstrIsUSAEmailAddress_Wide(wchar_t *, int *);
int PT_DECLSPEC pstrBracketEmail(char *, char *, int);
int PT_DECLSPEC pstrBracketEmail_Wide(wchar_t *, wchar_t *, int);
...
/* pstrHidden.cpp */
int PT_DECLSPEC pstrCalcHiddenString(wchar_t *, int, int, int, wchar_t *, int);
